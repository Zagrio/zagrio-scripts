...
$SecondaryServers = "46.4.76.209","2.179.73.249","2a04:2680:2b:10:2:179:73:249","2a01:4f8:140:5316::1"
$ZoneNames = Get-DnsServerZone | Where-Object IsAutoCreated -EQ $False | Where-Object IsReverseLookupZone -EQ $False | Select-Object -ExpandProperty ZoneName
foreach ($ZoneName in $ZoneNames){Set-DnsServerPrimaryZone -Name $ZoneName -SecureSecondaries TransferToSecureServers -SecondaryServers $SecondaryServers -Notify NotifyServers -NotifyServers $SecondaryServers -Verbose}
# SIG # Begin signature block
# MIIKVgYJKoZIhvcNAQcCoIIKRzCCCkMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQJwyvYvWI00Qv
# dta1JStYs9I3YCzksHUF9SXJiAbHKaCCCAAwggOrMIICk6ADAgECAhB3iG/eaHjQ
...
# vZKMjBoSY6M0ODGCAawwggGoAgEBMHMwXDETMBEGCgmSJomT8ixkARkWA2NvbTEW
...
# LwYJKoZIhvcNAQkEMSIEII/kPwZ/Zf5daLZcnACv4cHYj9t9qXgx2qvxgWN8SYm3
# MAsGByqGSM49AgEFAASBijCBhwJCAfJchm5XHUoowy2SHyjiOQMysgcvSVsKoJDb
# mr3OEVu4DEOtNxNT28bXdgQnu345iupjyTA462cGApSN6dMfKFARAkFASfkNpFON
# oQwevUMBY75ELbTv/UPtvgldtIHdUBEeNNDNYoTdw8FUiZjlLVmVH7UUmT6CncqL
# MtRYpjyPrCOhxw==
