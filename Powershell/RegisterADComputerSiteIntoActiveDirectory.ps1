...
# Register Computer Site in ActiveDirectory extensionAttribute1
# to query use below example
# Get-ADComputer -Filter 'extensionAttribute1 -eq "IR-ZAGRIO"'
$DomainLDAP = "LDAP://DC=zagrio,DC=com"
$Object = New-Object -ComObject ADSystemInfo
$Type = $Object.gettype()
$ADSite = $Type.InvokeMember("sitename","GetProperty",$null,$Object,$null)
if($ADSite -eq $null){$ADSite = "UNKNOWN"}
$ROOT = [ADSI]$DomainLDAP
$Search = [adsisearcher]$ROOT
$Name = $ENV:COMPUTERNAME
$Search.Filter = "(&(SamAccountName=$Name$))"
$Computer = $Search.FindOne() | foreach{$cproperties=$_.GetDirectoryEntry()}
$ADSiteinAD = $cproperties.extensionattribute1
if($ADSiteinAD -eq $ADSite){}else{
    $cproperties.extensionattribute1 = [string]$ADSite
    $cproperties.SetInfo()
}
# SIG # Begin signature block
# MIIKVgYJKoZIhvcNAQcCoIIKRzCCCkMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvceaKUU8QjGJV
# KSz2JBT2sjcfniydwhloyZXc9e1alaCCCAAwggOrMIICk6ADAgECAhB3iG/eaHjQ
...
# LwYJKoZIhvcNAQkEMSIEIPoyaVv48AKvMecDsWlozUD2CH4dHdH9JVWmLZova8IH
# MAsGByqGSM49AgEFAASBijCBhwJBJ849uf2GQuj31EYftTCjswYiGsTnyO5wBZsh
# xLW/zyxO1e4SgBJiXza+7gSSISPoS8d71MbRVRGVFMxAbun3pAMCQgEyhyftxjgN
# adqU4GiAx+S0xXxc4lNzD3ECJHcL/t9q6+5z0IfPEdG2THb+Dzncmq5I2bHCOufD
# WM+LsJHTCNcHaw==
